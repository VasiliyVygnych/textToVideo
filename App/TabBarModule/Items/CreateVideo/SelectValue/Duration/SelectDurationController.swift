...
class SelectDurationController: UIViewController {
    ...
    private let secondsTitle = HomeConstants.HomeText.secondsTitle.localized(LanguageConstant.appLaunguage)
//    var model = [HomeConstants.HomeText.firstDurationValue.localized(LanguageConstant.appLaunguage),
//                 HomeConstants.HomeText.secondDurationValue.localized(LanguageConstant.appLaunguage),
//                 HomeConstants.HomeText.thirdDuratinValue.localized(LanguageConstant.appLaunguage),
//                 HomeConstants.HomeText.fourthDuratinValue.localized(LanguageConstant.appLaunguage),
//                 HomeConstants.HomeText.fifthDuratinValue.localized(LanguageConstant.appLaunguage)]
    lazy var model = ["5 \(secondsTitle)",
                      "10 \(secondsTitle)"]
    ...
    private func setupeData() {
        ...
        case .youtubeShorts:
            otherTimeView.isHidden = true
            durationModel.append(contentsOf: shortsModel)
            selectStackView.snp.updateConstraints { make in
                make.height.equalTo(durationModel.count * 60)
            }
        case .instagramReels:
    ...
    @objc func selectButtonTapped(_ sender: UIButton) {
        selectValue = durationModel[sender.tag]
    ...
    @objc func saveDuration() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.2 ) { [weak self] in
            ...
            self?.delegate?.setDuration(value: self?.selectValue ?? "")
        }
    }
    deinit {
